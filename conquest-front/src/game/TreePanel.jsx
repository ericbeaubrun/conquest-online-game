...
// « Aucune » — même présentation que le panneau du soldat) et l'or gagné en
// l'abattant (déjà modulé par l'essence). S'il pousse sur le territoire d'un
// joueur, une dernière ligne montre l'or que cet arbre lui coûte chaque tour.
// Purement informatif — aucune action depuis ce panneau.
//
