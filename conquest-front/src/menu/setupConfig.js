...
export const GAME_SETTINGS = [
    ...
    {
        id: 'chestsEnabled',
        label: 'Apparition des coffres',
        group: 'Monde',
        type: 'toggle',
        help: 'Des coffres apparaissent au fil de la partie : un soldat les ouvre, le butin se ramasse.',
    },
    {
        id: 'chestSpawnChance',
        label: 'Probabilité d’apparition',
        ...
        step: 5,
        unit: '%',
        help: 'Chance qu’un coffre apparaisse à chaque tour.',
        dependsOn: 'chestsEnabled',
    },
    {
        id: 'chestMax',
        label: 'Coffres simultanés',
        group: 'Monde',
        type: 'number',
        min: 1,
        max: 20,
        step: 1,
        help: 'Nombre de coffres pouvant coexister sur le plateau.',
        dependsOn: 'chestsEnabled',
    },
    ...
    },
    {
        ...
        step: 1,
        unit: '⚔',
        help: 'Dégâts d’un soldat de niveau 1. Les niveaux supérieurs suivent les mêmes proportions.',
    },
    {
        id: 'bonusEnabled',
